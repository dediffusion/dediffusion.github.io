...
var INTERP_BASE = "./diffmae/interpolation";
...
function showBlock(blockId, prefix) {
  const blocks = document.querySelectorAll(`.content-block[id^=${prefix}]`);
...
document.addEventListener('DOMContentLoaded', (event) => {
  const image = document.getElementById('squareImage');
